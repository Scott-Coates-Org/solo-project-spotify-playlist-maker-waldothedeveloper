  ...
  return (
    <div>
      <div className="mx-auto max-w-2xl py-16 px-6 text-center sm:py-20 lg:px-8">
        <p className="text-lg font-semibold text-red-100">Powered by SMX</p>
        <h2 className="mt-4 font-bold tracking-tight text-slate-50 text-4xl lg:text-5xl">
          Spotify Playlist Generator
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-lg text-red-50">
